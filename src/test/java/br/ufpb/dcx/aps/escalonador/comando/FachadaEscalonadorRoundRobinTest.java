...
import static br.ufpb.dcx.aps.escalonador.TestHelper.checaStatus;
import static br.ufpb.dcx.aps.escalonador.TestHelper.checaStatusBloqueio;
import static br.ufpb.dcx.aps.escalonador.TestHelper.checaStatusFila;
import static br.ufpb.dcx.aps.escalonador.TestHelper.checaStatusRodando;
import static br.ufpb.dcx.aps.escalonador.TestHelper.checaStatusRodandoBloqueio;
import static br.ufpb.dcx.aps.escalonador.TestHelper.checaStatusRodandoFila;
import static br.ufpb.dcx.aps.escalonador.TestHelper.checaStatusRodandoFilaBloqueio;
import static br.ufpb.dcx.aps.escalonador.TestHelper.ticks;
...
public class FachadaEscalonadorRoundRobinTest {
	...
	public void t04_finalizarProcessoEmExecução() {
		...
		fachada.execute(new ComandoTick(fachada));//Só efetua a ação no próximo tick
